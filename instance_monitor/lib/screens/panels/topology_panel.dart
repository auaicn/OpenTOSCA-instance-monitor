...
class TopologyPanel extends StatefulWidget {
  @override
  State<TopologyPanel> createState() => _TopologyPanelState();
}

class _TopologyPanelState extends State<TopologyPanel> with TickerProviderStateMixin {
  Animation animation;
